				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 animate-box">
						...
						<div class="row contact-info-wrap">
							<div class="col-md-4">
								<p><span><i class="icon-location-2"></i></span>No 34 Tamale street,<br /> Off Barnenda street,<br /> Wuse Zone 3, Abuja</p>
							</div>
							<div class="col-md-4">
								<p><span><i class="icon-phone3"></i></span> <a href="tel://1234567920">0806 909 6561</a></p>
							</div>
							<div class="col-md-4">
								<p><span><i class="icon-paperplane"></i></span> <a href="mailto:info@yoursite.com">info@interweb.ng</a></p>
							</div>
						...
						<form action="#">
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="More detail here"></textarea>
								</div>
							</div>
